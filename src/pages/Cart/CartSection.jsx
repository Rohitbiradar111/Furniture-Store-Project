      ...
      tableColumnHelper.accessor("image_path", {
        ...
        header: () => (
          <Text
            size="texts"
            as="p"
            className="text-[14px] font-normal uppercase !text-black-900 underline underline-offset-8"
          >
            Product
          </Text>
        ),
      ...
      tableColumnHelper.accessor("name", {
        cell: (info) => (
          <Text
            size="textsm"
            as="p"
            className=" ml-8 flex flex-wrap text-[16px] font-normal !text-black-900"
          >
            {info.getValue()}
          </Text>
        ),
        header: () => (
          <Text
            size="texts"
            as="p"
            className="ml-5 text-[14px] font-normal uppercase !text-black-900 underline underline-offset-8"
          >
            Product Name
          </Text>
        ),
      ...
      tableColumnHelper.accessor("discount_price", {
        cell: (info) => (
          <Text
            size="textxl"
            as="p"
            className="ml-10 text-[18px] font-normal !text-black-900"
          >
            ${info.getValue()}
          </Text>
        ),
        ...
        cell: (info) => (
          <div className="ml-5 mr-5 flex flex-col items-center">
            <Text
              size="textxl"
              as="p"
              className="mb-3.5 text-[18px] font-normal !text-black-900"
            >
        ...
        <div className="container-xs flex flex-col gap-[38px] md:px-5">
          <div className="mx-[218px] flex items-center rounded-[16px] border border-solid border-gray-200_01 md:mx-0 md:flex-col">
            ...
            <div className="flex w-full flex-wrap items-center gap-4 border-r border-solid border-gray-200_01 px-6 py-4 sm:px-5">
              ...
              <Text
                size="texts"
                as="p"
                className="mb-2.5 self-end text-[14px] font-medium"
              >
                Shipping address
              </Text>
            </div>
          ...
          <div className="flex items-start gap-6 md:flex-col">
            <ReactTable
              size="xs"
              bodyProps={{ className: "" }}
              className="sm:w-full border border-solid border-gray-200_01 p-3 md:block md:overflow-x-auto md:whitespace-nowrap"
            ...
            <div className="flex w-[32%] flex-col gap-[30px] self-center rounded-[16px] border border-solid border-gray-200_01 px-4 py-[18px] md:w-full">
              <div className="flex flex-col items-start gap-3">
                <Text
                  size="texts"
                  as="p"
                  className="text-[14px] font-normal uppercase !text-black-900"
                >
                  Cart value :
                </Text>
                <div className="flex flex-col gap-[18px] self-stretch">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-5">
                    ...
                    <Text
                      as="p"
                      className="text-[16px] font-medium !text-black-900"
                    >
                      $
                      {cart
                        .reduce(
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-5">
                    <Text
                      as="p"
                      className="self-start text-[16px] font-normal !text-black-900"
                    >
                      Total :
                    </Text>
                    <Heading
