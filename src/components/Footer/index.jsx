...
export default function Footer({ ...props }) {
    return (
        <footer {...props} className={`${props.className} flex py-4 border-gray-200_01 border-t border-solid`}>
                ...
                <div className="container-xs flex flex-col gap-5 md:px-5">
                    <div className="flex items-center justify-between gap-5 md:flex-col">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="mr-1.5 flex flex-col items-start gap-[18px] md:mr-0">
                                    ...
                                    <div className="flex gap-2">
                                        <Img src="images/img_call_gray_600_01.svg" alt="Phone Icon" className="h-[20px]" />
                        ...
                        <div className="flex w-[40%] items-start justify-between gap-5 md:w-full sm:flex-col">
                            ...
                            <div className="flex flex-col items-start gap-[18px] self-center w-[40%]">
                                <Heading size="headingmd" as="h6" className="text-[18px] font-semibold">
                                    Our Company
                                </Heading>
